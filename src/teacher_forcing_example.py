...
num_neurons = 256  # Latent dimensionality of the encoding space.
...
decoder_state_input_h = keras.Input(shape=(num_neurons,))
decoder_state_input_c = keras.Input(shape=(num_neurons,))

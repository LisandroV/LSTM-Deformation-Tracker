"""
In this file a basic recurrent neural network is trained with the npy data.
"""
...
plotter.plot_npz_control_points(
    predicted_polygons[1:], title="One-Step Prediction On Train Set", plot_cb=origin_axis_plot
)
...
plotter.plot_npz_control_points(
    predicted_polygons[1:], title="One-Step Prediction On Validation Set", plot_cb=origin_axis_plot
)